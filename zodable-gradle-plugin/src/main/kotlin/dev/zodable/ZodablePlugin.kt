...
import dev.zodable.Files.pythonCompatible
import dev.zodable.extensions.ZodableExtension
...
abstract class ZodablePlugin : Plugin<Project> {
    ...
    private val zodableVersion = "1.7.5"
    ...
    private fun Project.configureKspProcessor() {
        ...
        dependencies {
            if (project.group == "dev.zodable") {
                ...
                add(kspConfig.apiConfigurationName, "dev.zodable:zodable-annotations:$zodableVersion")
                add(kspConfig.kspConfigurationName, "dev.zodable:zodable-ksp-processor:$zodableVersion")
            }
        }
    }
